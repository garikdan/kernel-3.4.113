...
/* Vanzo:maxiaojun on: Tue, 26 Nov 2013 15:15:00 +0800
 * board device name support.
 *//*
#define VANZO_DEVICE_NAME_SUPPORT
...
static int __init mt_gpio_init(void)
{
    int ret = 0;
    GPIOLOG("version: %s\n", VERSION);
/* Vanzo:maxiaojun on: Tue, 26 Nov 2013 15:16:19 +0800
 * board device name support.
 *//*
#ifdef VANZO_DEVICE_NAME_SUPPORT
    v_set_dev_name(0, "MT6592");
...
{
/* Vanzo:maxiaojun on: Tue, 26 Nov 2013 15:16:45 +0800
 * board device name support.
 *//*
#ifdef VANZO_DEVICE_NAME_SUPPORT
