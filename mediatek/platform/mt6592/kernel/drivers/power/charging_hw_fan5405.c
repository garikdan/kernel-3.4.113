...
/* Vanzo:zhangxinyu on: Mon, 16 Dec 2013 11:33:14 +0800
 * TODO: replace this line with your comment
   fan5405_reg_config_interface(0x06,0x77); // ISAFE = 1250mA, VSAFE = 4.34V
  */
   fan5405_reg_config_interface(0x06,0x77); // ISAFE = 1250mA, VSAFE = 4.36V
   fan5405_reg_config_interface(0x02,0xae);
// End of Vanzo:	* *zhangxinyu
    ...
    if ( !charging_init_flag ) {   
		...
		if(Bq27520_Exist)
		{
			fan5405_reg_config_interface(0x04,0x12); //100mA      0x1A -> 146mA
		}
		else
		{
			fan5405_reg_config_interface(0x04,0x1A); //100mA      0x1A -> 146mA
		}
#else
			fan5405_reg_config_interface(0x04,0x1A); //100mA      0x1A -> 146mA
#endif
