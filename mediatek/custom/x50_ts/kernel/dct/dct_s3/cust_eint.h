...
#define CUST_EINT_TOUCHKEY_NUM              6
#define CUST_EINT_TOUCHKEY_DEBOUNCE_CN      1
#define CUST_EINT_TOUCHKEY_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_TOUCHKEY_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
